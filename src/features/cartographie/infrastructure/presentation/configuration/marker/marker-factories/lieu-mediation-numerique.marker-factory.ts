...
const cnfsIconMarkerSvg = (lieuMediationNumeriqueClasse: string): string => `
<svg class="lieu-mediation-numerique-marker ${lieuMediationNumeriqueClasse}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
...
const lieuMediationIconMarkerSvg = (
  lieuMediationNumeriqueClasse: string
): string => `<svg class="lieu-mediation-numerique-marker ${lieuMediationNumeriqueClasse}" version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" width="250.90668" height="250.06667" viewBox="0 0 942.2 1080">
...
const lieuMediationNumeriqueMarkerHtmlTemplate = (
  ...
  labels_nationaux?.includes('CNFS')
    ? lieuMediationIconMarkerSvg(lieuMediationNumeriqueClass)
    : cnfsIconMarkerSvg(lieuMediationNumeriqueClass);
