...
export const toStructurePresentation = (lieuMediationNumerique: LieuMediationNumerique): Structure =>
  new Structure({
...
export const toStructuresPresentation = (lieuxMediationNumerique: LieuMediationNumerique[]): Structure[] =>
