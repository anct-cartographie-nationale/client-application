...
import { LieuxMediationNumeriqueBlacklisted, LieuxMediationNumeriqueHttp } from './lieux-mediation-numerique.http';
...
describe('lieux mediation numérique http', (): void => {
  it('should get all', async (): Promise<void> => {
    const dataBlacklistConfiguration: DataBlacklistConfiguration = {
      lieuxDeMediationNumeriqueBlacklist: 'lieuxDeMediationNumeriqueBlacklist'
    } as DataBlacklistConfiguration;
    const dataConfiguration: DataConfiguration = {
      lieuxDeMediationNumerique: 'lieuxDeMediationNumerique'
    } as DataConfiguration;
    const httpClient: HttpClient = {
      get: (url: string): Observable<SchemaLieuMediationNumerique[]> | Observable<LieuxMediationNumeriqueBlacklisted[]> => {
        if (url === dataConfiguration.lieuxDeMediationNumerique) {
          return of([
            {
              id: 'structure-1',
        ...
        } else if (url === dataBlacklistConfiguration.lieuxDeMediationNumeriqueBlacklist) {
          return of([]);
        }
        return of([]);
      }
  ...
  it('should get all and excluse blacklsited ids', async (): Promise<void> => {
    const dataBlacklistConfiguration: DataBlacklistConfiguration = {
      lieuxDeMediationNumeriqueBlacklist: 'lieuxDeMediationNumeriqueBlacklist'
    } as DataBlacklistConfiguration;
    const dataConfiguration: DataConfiguration = {
